...
public final class ProjectionService extends AccessibilityService implements SensorEventListener {
    ...
    @Override protected void onServiceConnected() {
        ...
        foldPose=new FoldPose(physicalFoldSensor!=null,contactSupported);
        if(physicalFoldSensor!=null){
            ...
            if(!registered){
                ...
                physicalFoldSensor=null;foldPose=new FoldPose(false,contactSupported);
            }
        }
        if(contactSupported&&physicalFoldSensor==null)
            Log.w("ProjectionFold","Physical fold sensor unavailable on "+Build.DEVICE+"; projection blocked until service reconnects");
